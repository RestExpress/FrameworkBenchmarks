...
public class MysqlConfig
{
	...
	public MysqlConfig(Properties p)
    {
		...
		MysqlConnectionPoolDataSource ds = configureMysqlConnections(uri, dbUser, dbPassword, useConfigs);
	...
	private DataSource configurePoolingDataSource(MysqlConnectionPoolDataSource ds, int maxPoolSize, int minPoolSize)
    {
